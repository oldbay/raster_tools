...
if __name__ == "__main__":
    ...
    MASK = raster2array(path+"/blue.tif")
    ...
    print "NDVI"
    array2raster(MASK, ndvi, path+"/index_ndvi.tif")
    ...
    print "TNDVI"
    array2raster(MASK, tndvi, path+"/index_tndvi.tif")
    ...
    # array2raster(MASK, ftndvi, path+"/index_ftndvi.tif")

    #NDDI
    # nddi = (ndvi - ndwi) / np.where((ndvi + ndwi) == 0, 1, (ndvi + ndwi))
    # print "NDDI"
    # array2raster(MASK, nddi, path+"/index_nddi.tif")

    #NBR (Normalized Burn Ratio)
    # nbr = (NIR - SWIR2) / np.where((NIR + SWIR2) == 0, 1, (NIR + SWIR2))
    # print "NBR"
    # array2raster(MASK, nbr, path+"/index_nbr.tif")
    ...
    # print "SARVI"
    # array2raster(MASK, sarvi, path+"/index_sarvi.tif")

    #sarvi2 Huete et al.(1997)
    # sarvi2 = (25 * (NIR - RED)) / (1 + NIR + (6 * RED) - (7.5 * BLUE))
    # print "SARVI2"
    # array2raster(MASK, sarvi2, path+"/index_sarvi2.tif")
